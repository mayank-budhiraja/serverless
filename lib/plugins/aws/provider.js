...
Object.defineProperties(
  ...
  memoizeeMethods({
    ...
    resolveImageUriAndShaFromPath: d(
      async function (imageName, imagePath, imageFilename, buildArgs, cacheFrom) {
        ...
        if (_.isObject(imageDefinedInProvider)) {
          ...
          if (imageDefinedInProvider.path) {
            return await this.resolveImageUriAndShaFromPath(
              ...
              imageDefinedInProvider.buildArgs || defaultBuildArgs,
              imageDefinedInProvider.cacheFrom || defaultCacheFrom
            );
          }
